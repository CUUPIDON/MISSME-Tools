...
class MissMePanel(bpy.types.Panel):
    ...
    bl_label = "MISSME Tools: Clothing Creation"
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.label(text="When you've done that, click the buttons at the bottom to run the scripts." , icon= 'INFO')
...
#Finished?                  
        ...
        row = layout.row()            
        row.label(text="When you're sure it's perfect, you can import it into Sims 4 Studio!", icon= 'INFO')  
